...
export const commandCenterRiskModeling: CaseStudyTemplateContent = {
  ...
  quote: "The product stopped feeling like software we had to fight. It started feeling like an instrument.",
