...
import { BodyLead, Caption, Display } from "../components/primitives/Typography";
...
export const HomePage = () => (
  <>
    <section className="border-b border-hedge bg-hero-gradient px-6 py-16 sm:px-10 sm:py-20 lg:px-gutter lg:py-24">
      <Caption className="mb-7 text-caption">Product designer — hard-tech & field-critical software</Caption>
      <Display>
      ...
      <div className="mt-11 flex flex-wrap items-center gap-3.5">
        <Button to="/#work" variant="primary" className="!px-[26px] !py-4 !text-[0.8125rem]">
          See the work
        </Button>
        <Button href="/#about" variant="secondary" className="!px-[26px] !py-[15px] !text-[0.8125rem]" showArrow>
          About
        </Button>
      </div>
    </section>
    ...
    <section id="work" className="border-b border-hedge px-6 py-[72px] sm:px-10 lg:px-gutter">
      <div className="mb-9 flex flex-col gap-4 sm:flex-row sm:items-baseline sm:justify-between">
        ...
        <Button to="/case-study/originality" variant="text" className="!text-xs" showArrow>
          All case studies
        </Button>
      </div>
